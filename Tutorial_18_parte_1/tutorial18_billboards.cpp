...
int main( void )
{
	...
	do
	{
		...
		// Traslación para acercar y alejar el cubo
		float distance = sin(currentTime) * 2.0f;  // Oscila entre -2.0 y 2.0
		cubeModelMatrix = glm::translate(cubeModelMatrix, glm::vec3(0.0f, 0.0f, distance));

		// Rotación del cubo
		cubeModelMatrix = glm::rotate(cubeModelMatrix, (float)currentTime, glm::vec3(0.0f, 1.0f, 0.0f));
