...
"void main()\n"
"{\n"
// Azul con 60% de opacidad
"   FragColor = vec4(0.0f, 0.0f, 0.8f, 0.6f);\n" // Asigna un color RGBA (rojo, verde, azul, alfa)
"}\n\0";
...
int main()
{
	...
	// Crear un objeto GLFWwindow de 1000 por 800 píxeles, llamándolo "triangulo_MSH"
	GLFWwindow* window = glfwCreateWindow(1000, 800, "Triangulo_MSH", NULL, NULL); // Crea la ventana de 800x800 píxeles
	...
	// En este caso el área va de x = 0, y = 0, a x = 1000, y = 800
	glViewport(0, 0, 1000,800); // Define el área de visualización de OpenGL
	...
	while (!glfwWindowShouldClose(window)) // Mientras la ventana no deba cerrarse
	{
		...
		glClearColor(0.0f, 1.0f, 0.984f, 1.0f); // Establece el color de fondo a #00FFFB (cyan claro)
