...
int main( void )
{
	...
	do{
		...
		glm::mat4 ModelMatrix = glm::rotate(glm::mat4(1.0), (float)glfwGetTime(), glm::vec3(0.0f, 1.0f, 0.0f)) * // Rotación
			glm::scale(glm::mat4(1.0), glm::vec3(1.0f, 1.0f, 1.0f)); // Escala
		glm::mat4 MVP = ProjectionMatrix * ViewMatrix * ModelMatrix;
		glUniformMatrix4fv(MatrixID, 1, GL_FALSE, &MVP[0][0]);
		printf("ModelMatrix: [%f, %f, %f]\n", ModelMatrix[0][0], ModelMatrix[1][1], ModelMatrix[2][2]);	
